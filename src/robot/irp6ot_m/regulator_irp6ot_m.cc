...
uint8_t NL_regulator_1_irp6ot::compute_set_value(void)
{
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradowe
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[0] / 158);
...
uint8_t NL_regulator_3_irp6ot::compute_set_value(void)
{
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradowe
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[1] / 158);
			current_measured = (measured_current - 128 - 3) * 0.035;
			current_error = current_desired - current_measured;
			int_current_error = int_current_error + current_error * 0.02; // 500Hz => 0.02s
			//int_current_error = 0;
...
uint8_t NL_regulator_4_irp6ot::compute_set_value(void)
{
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradowe
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[2] / 158);
			current_measured = (measured_current - 128 - 3) * 0.035;
			current_error = current_desired - current_measured;
			int_current_error = int_current_error + current_error * 0.02; // 500Hz => 0.02s
			//int_current_error = 0;
...
//	double step_new_pulse; // nastepna wartosc zadana dla jednego kroku regulacji
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradowe
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[3] / 158);
			current_measured = (measured_current - 128 - 3) * 0.035;
			current_error = current_desired - current_measured;
			int_current_error = int_current_error + current_error * 0.02; // 500Hz => 0.02s
			//int_current_error = 0;
			...
			if (display >= 500) {
				display = 0;
				printf("joint 4:   desired_current = %f,    current_error = %f,    out = %f\n", master.ecp_instruction.arm.pf_def.desired_torque_or_current[3]
...
uint8_t NL_regulator_6_irp6ot::compute_set_value(void)
{
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradowe
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[4] / 158);
			current_measured = (measured_current - 128 - 3) * 0.035;
			current_error = current_desired - current_measured;
			int_current_error = int_current_error + current_error * 0.02; // 500Hz => 0.02s
			//int_current_error = 0;
...
//			- 0.980 * (step_old_pulse - position_increment_old);
	...
	switch (algorithm_no)
	{
		...
		case 2: // algorytm nr 2 - sterowanie pradoweb0 =
			// DUNG START
			current_desired = 0.4 * 9.52 * (master.ecp_instruction.arm.pf_def.desired_torque_or_current[5] / 158);
			...
			if (display >= 500) {
				display = 0;
				printf("joint 6:   desired_current = %f,    current_error = %f,    out = %f\n", master.ecp_instruction.arm.pf_def.desired_torque_or_current[5]
						/ 158, current_error, -30 * current_error - 4.0 * int_current_error);
			}
			// DUNG END
			break;
