#if !defined(_ECP_MP_G_ASKUBIS_SINUSOIDAL_VELOCITY_H)
#define _ECP_MP_G_ASKUBIS_SINUSOIDAL_VELOCITY_H
 ...
 */
const std::string ECP_GEN_ASKUBIS_SINUSOIDAL_VELOCITY = "ECP_GEN_ASKUBIS_SINUSOIDAL_VELOCITY";
