#if !defined(_ECP_GEN_ASKUBIS_SINUSOIDAL_VELOCTIY_H)
#define _ECP_GEN_ASKUBIS_SINUSOIDAL_VELOCTIY_H
 ...
 * @ingroup generators
 */
class askubis_sinusoidal_velocity : public common::generator::generator
{
protected:
...
public:
	 ...
	 */
	askubis_sinusoidal_velocity(common::task::task& _ecp_task, int step = 0);
...
// end : class ecp_askubis_sinusoidal_velocity_generator
